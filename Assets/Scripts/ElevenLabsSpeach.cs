...
namespace ElevenLabs.Demo
{
    ...
    public class ElevenLabsSpeech : MonoBehaviour
    {
        [SerializeField]
        ...
        private void Start()
        {
            button.onClick.AddListener(PlayMessage);
        }
        private async void PlayMessage()
        {
            ...
            try
            {
                ...
                var request = new TextToSpeechRequest(voice, txt.text, model: Model.FlashV2_5, outputFormat: OutputFormat.PCM_24000);
